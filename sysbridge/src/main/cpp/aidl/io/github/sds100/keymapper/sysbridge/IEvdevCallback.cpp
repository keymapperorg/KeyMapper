            ...
            namespace sds100 {
                namespace keymapper {
                    namespace sysbridge {
                        ...
                        _aidl_io_github_sds100_keymapper_sysbridge_IEvdevCallback_onTransact(
                                AIBinder *_aidl_binder, transaction_code_t _aidl_code,
                                const AParcel *_aidl_in, AParcel *_aidl_out) {
                            (void) _aidl_in;
                            (void) _aidl_out;
                            binder_status_t _aidl_ret_status = STATUS_UNKNOWN_TRANSACTION;
                            std::shared_ptr<BnEvdevCallback> _aidl_impl = std::static_pointer_cast<BnEvdevCallback>(
                                    ::ndk::ICInterface::asInterface(_aidl_binder));
                            switch (_aidl_code) {
                                case (FIRST_CALL_TRANSACTION + 0 /*onEvdevEvent*/): {
                                    int32_t in_type;
                                    int32_t in_code;
                                    int32_t in_value;
                                    ...
                                    ::ndk::ScopedAStatus _aidl_status = _aidl_impl->onEvdevEvent(
                                            in_type, in_code, in_value);
                                    _aidl_ret_status = AParcel_writeStatusHeader(_aidl_out,
                                                                                 _aidl_status.get());
                                    if (_aidl_ret_status != STATUS_OK) break;
                        ...
                        static AIBinder_Class *_g_aidl_io_github_sds100_keymapper_sysbridge_IEvdevCallback_clazz = ::ndk::ICInterface::defineClass(
                                IEvdevCallback::descriptor,
                                _aidl_io_github_sds100_keymapper_sysbridge_IEvdevCallback_onTransact);

                        BpEvdevCallback::BpEvdevCallback(const ::ndk::SpAIBinder &binder)
                                : BpCInterface(binder) {}

                        BpEvdevCallback::~BpEvdevCallback() {}

                        ::ndk::ScopedAStatus
                        BpEvdevCallback::onEvdevEvent(int32_t in_type, int32_t in_code,
                                                      int32_t in_value) {
                            ...
                            _aidl_ret_status = AIBinder_prepareTransaction(asBinder().get(),
                                                                           _aidl_in.getR());
                            ...
                            _aidl_ret_status = AIBinder_transact(
                                    asBinder().get(),
                                    (FIRST_CALL_TRANSACTION + 0 /*onEvdevEvent*/),
                                    _aidl_in.getR(),
                                    _aidl_out.getR(),
                                    0
                            ...
                            if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION &&
                                IEvdevCallback::getDefaultImpl()) {
                                _aidl_status = IEvdevCallback::getDefaultImpl()->onEvdevEvent(
                                        in_type, in_code, in_value);
                                goto _aidl_status_return;
                            }
                            if (_aidl_ret_status != STATUS_OK) goto _aidl_error;

                            _aidl_ret_status = AParcel_readStatusHeader(_aidl_out.get(),
                                                                        _aidl_status.getR());
                            if (_aidl_ret_status != STATUS_OK) goto _aidl_error;
...
// Source for BnEvdevCallback
                        ...
                        ::ndk::SpAIBinder BnEvdevCallback::createBinder() {
                            AIBinder *binder = AIBinder_new(
                                    _g_aidl_io_github_sds100_keymapper_sysbridge_IEvdevCallback_clazz,
...
// Source for IEvdevCallback
                        ...
                        std::shared_ptr<IEvdevCallback>
                        IEvdevCallback::fromBinder(const ::ndk::SpAIBinder &binder) {
                            if (!AIBinder_associateClass(binder.get(),
                                                         _g_aidl_io_github_sds100_keymapper_sysbridge_IEvdevCallback_clazz)) {
                            ...
                            std::shared_ptr<::ndk::ICInterface> interface = ::ndk::ICInterface::asInterface(
                                    binder.get());
                            if (interface) {
                        ...
                        binder_status_t IEvdevCallback::writeToParcel(AParcel *parcel,
                                                                      const std::shared_ptr<IEvdevCallback> &instance) {
                            return AParcel_writeStrongBinder(parcel,
                                                             instance ? instance->asBinder().get()
                                                                      : nullptr);
                        }

                        binder_status_t IEvdevCallback::readFromParcel(const AParcel *parcel,
                                                                       std::shared_ptr<IEvdevCallback> *instance) {
                            ::ndk::SpAIBinder binder;
                            binder_status_t status = AParcel_readStrongBinder(parcel,
                                                                              binder.getR());
                        ...
                        bool IEvdevCallback::setDefaultImpl(
                                const std::shared_ptr<IEvdevCallback> &impl) {
                        ...
                        ::ndk::ScopedAStatus
                        IEvdevCallbackDefault::onEvdevEvent(int32_t /*in_type*/,
                                                            int32_t /*in_code*/,
                                                            int32_t /*in_value*/) {
                            ::ndk::ScopedAStatus _aidl_status;
