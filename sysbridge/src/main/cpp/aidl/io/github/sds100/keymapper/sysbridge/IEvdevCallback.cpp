  ...
  switch (_aidl_code) {
    case (FIRST_CALL_TRANSACTION + 0 /*onEvdevEvent*/): {
      ...
      if (_aidl_ret_status != STATUS_OK) break;
        ...
        ::ndk::ScopedAStatus _aidl_status = _aidl_impl->onEvdevEvent(in_deviceId, in_timeSec,
                                                                     in_timeUsec, in_type, in_code,
                                                                     in_value, in_androidCode);
...
BpEvdevCallback::~BpEvdevCallback() {}
    ...
    ::ndk::ScopedAStatus
    BpEvdevCallback::onEvdevEvent(int32_t in_deviceId, int64_t in_timeSec, int64_t in_timeUsec,
                                  int32_t in_type, int32_t in_code, int32_t in_value,
                                  int32_t in_androidCode) {
  ...
  if (_aidl_ret_status == STATUS_UNKNOWN_TRANSACTION && IEvdevCallback::getDefaultImpl()) {
      _aidl_status = IEvdevCallback::getDefaultImpl()->onEvdevEvent(in_deviceId, in_timeSec,
                                                                    in_timeUsec, in_type, in_code,
                                                                    in_value, in_androidCode);
...
std::shared_ptr<IEvdevCallback> IEvdevCallback::default_impl = nullptr;
    ...
    ::ndk::ScopedAStatus
    IEvdevCallbackDefault::onEvdevEvent(int32_t /*in_deviceId*/, int64_t /*in_timeSec*/,
                                        int64_t /*in_timeUsec*/, int32_t /*in_type*/,
                                        int32_t /*in_code*/, int32_t /*in_value*/,
                                        int32_t /*in_androidCode*/) {
  ::ndk::ScopedAStatus _aidl_status;
