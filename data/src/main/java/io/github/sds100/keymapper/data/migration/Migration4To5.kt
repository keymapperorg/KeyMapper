...
object Migration4To5 {
            ...
            query(query).apply {
                ...
                while (moveToNext()) {
                    ...
                    if (flags.hasFlag(OLD_KEYMAP_FLAG_REPEAT_ACTIONS)) {
                        ...
                        val holdDownDelay =
                            trigger["extras"].asJsonArray.getExtraData(
    ...
    private fun JsonArray.getExtraData(id: String): String? = singleOrNull { it["id"].asString == id }?.get("data")?.asString

    private fun JsonArray.putExtra(
        id: String,
        data: String,
    ) {
        val obj =
