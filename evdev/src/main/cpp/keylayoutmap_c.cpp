...
int keylayoutmap_map_key(KeyLayoutMapHandle handle, int32_t scan_code,
    ...
    // Pass 0 for usage_code as it's not used
    android::status_t status = (*map_ptr)->mapKey(scan_code, 0, out_key_code, out_flags);
