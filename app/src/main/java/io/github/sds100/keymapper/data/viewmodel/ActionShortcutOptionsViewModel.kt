...
class ActionShortcutOptionsViewModel : BaseOptionsDialogViewModel<ActionShortcutOptions>() {
    ...
    override fun createSliderListItemModel(option: BehaviorOption<Int>): SliderListItemModel = when (option.id) {
    ...
    override fun createCheckboxListItemModel(option: BehaviorOption<Boolean>): CheckBoxListItemModel = when (option.id) {
