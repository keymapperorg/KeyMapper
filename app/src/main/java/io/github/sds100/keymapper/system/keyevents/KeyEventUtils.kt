...
object KeyEventUtils {
     ...
     */
    private val NON_CHARACTER_KEY_LABELS: Map<Int, String> = sequence {
        yieldAll(
            listOf(
    ...
    private val KEYCODES: Set<Int> = setOf(
    ...
    private val KEYCODES_API_23: Set<Int> = setOf(
    ...
    private val KEYCODES_API_24: Set<Int> = setOf(
    ...
    private val KEYCODES_API_25: Set<Int> = setOf(
    ...
    private val KEYCODES_API_28: Set<Int> = setOf(
        KeyEvent.KEYCODE_ALL_APPS
    )

    val GET_EVENT_LABEL_TO_KEYCODE: Map<String, Int> = mapOf(
    ...
    val MODIFIER_KEYCODES: Set<Int> = setOf(
        KeyEvent.KEYCODE_SHIFT_LEFT,
        KeyEvent.KEYCODE_SHIFT_RIGHT,
        KeyEvent.KEYCODE_ALT_LEFT,
        KeyEvent.KEYCODE_ALT_RIGHT,
