...
class NewConfigKeymapViewModel(private val mKeymapRepository: ConfigKeymapUseCase,
    ...
    class Factory(
        ...
        override fun <T : ViewModel?> create(modelClass: Class<T>) =
            NewConfigKeymapViewModel(mConfigKeymapUseCase, mDeviceInfoRepository, mIPreferenceDataStore, mId) as T
    }
}