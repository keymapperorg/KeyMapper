...
data class AppNotFound(val packageName: String) : RecoverableFailure()
data class AppDisabled(val packageName: String) : RecoverableFailure()
...
data class GenericFailure(val exception: Exception) : Failure()
object EmptyJson : Failure()
class OptionsNotRequired : Failure()
data class SystemFeatureNotSupported(val feature: String) : Failure()
class ConstraintNotFound : Failure()
data class ExtraNotFound(val extraId: String) : Failure()
class NoActionData : Failure()
data class SdkVersionTooLow(val sdkVersion: Int) : Failure()
data class SdkVersionTooHigh(val sdkVersion: Int) : Failure()
data class FeatureUnavailable(val feature: String) : Failure()
data class SystemActionNotFound(val id: String) : Failure()
class KeyMapperImeNotFound : Failure()
data class InputMethodNotFound(val id: String) : Failure()
data class OptionLabelNotFound(val id: String) : Failure()
...
data class ImeNotFound(val id: String) : Failure()
class DownloadFailed : Failure()
class FileNotCached : Failure()
class SSLHandshakeError : Failure()
class DeviceNotFound : Failure()
data class FailedToSplitString(val string: String) : Failure()
class InvalidNumber : Failure()
data class NumberTooBig(val max: Int) : Failure()
data class NumberTooSmall(val min: Int) : Failure()
class CantBeEmpty : Failure()
class NoIncompatibleKeyboardsInstalled : Failure()
class NoMediaSessions : Failure()
data class UnknownFileLocation(val path: String) : Failure()
object BackupVersionTooNew : Failure()
object CorruptJsonFile : Failure()