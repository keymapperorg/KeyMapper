...
class FileNotCached() : Failure(appStr(R.string.error_file_not_cached))
class SSLHandshakeError() : Failure(appStr(R.string.error_ssl_handshake_exception))
class DeviceNotFound(descriptor: String) : Failure(appStr(R.string.error_device_not_found))