...
object ActionUtils {
    ...
    fun getNewIcon(id: ActionId): Icon {
        return when (id) {
            ActionId.TOGGLE_WIFI -> Icon.ImageVector(Icons.Outlined.Wifi)
            ActionId.ENABLE_WIFI -> Icon.ImageVector(Icons.Outlined.Wifi)
            ActionId.DISABLE_WIFI -> Icon.ImageVector(Icons.Outlined.WifiOff)
            ActionId.TOGGLE_BLUETOOTH -> Icon.ImageVector(Icons.Outlined.Bluetooth)
            ActionId.ENABLE_BLUETOOTH -> Icon.ImageVector(Icons.Outlined.Bluetooth)
            ActionId.DISABLE_BLUETOOTH -> Icon.ImageVector(Icons.Outlined.BluetoothDisabled)
            ActionId.TOGGLE_MOBILE_DATA -> Icon.ImageVector(Icons.Outlined.SignalCellular4Bar)
            ActionId.ENABLE_MOBILE_DATA -> Icon.ImageVector(Icons.Outlined.SignalCellular4Bar)
            ActionId.DISABLE_MOBILE_DATA -> Icon.ImageVector(Icons.Outlined.MobiledataOff)
            ActionId.TOGGLE_AUTO_BRIGHTNESS -> Icon.ImageVector(Icons.Outlined.BrightnessAuto)
            ActionId.ENABLE_AUTO_BRIGHTNESS -> Icon.ImageVector(Icons.Outlined.BrightnessAuto)
            ActionId.DISABLE_AUTO_BRIGHTNESS -> Icon.ImageVector(Icons.Outlined.BrightnessLow)
            ActionId.INCREASE_BRIGHTNESS -> Icon.ImageVector(Icons.Outlined.BrightnessHigh)
            ActionId.DECREASE_BRIGHTNESS -> Icon.ImageVector(Icons.Outlined.BrightnessLow)
            ActionId.TOGGLE_AUTO_ROTATE -> Icon.ImageVector(Icons.Outlined.ScreenRotation)
            ActionId.ENABLE_AUTO_ROTATE -> Icon.ImageVector(Icons.Outlined.ScreenRotation)
            ActionId.DISABLE_AUTO_ROTATE -> Icon.ImageVector(Icons.Outlined.ScreenLockRotation)
            ActionId.PORTRAIT_MODE -> Icon.ImageVector(Icons.Outlined.StayCurrentPortrait)
            ActionId.LANDSCAPE_MODE -> Icon.ImageVector(Icons.Outlined.StayCurrentLandscape)
            ActionId.SWITCH_ORIENTATION -> Icon.ImageVector(Icons.Outlined.RotateLeft)
            ActionId.CYCLE_ROTATIONS -> Icon.ImageVector(Icons.Outlined.ScreenRotation)
            ActionId.VOLUME_UP -> Icon.ImageVector(Icons.Outlined.VolumeUp)
            ActionId.VOLUME_DOWN -> Icon.ImageVector(Icons.Outlined.VolumeDown)
            ActionId.VOLUME_SHOW_DIALOG -> Icon.ImageVector(Icons.Outlined.Equalizer)
            ActionId.CYCLE_RINGER_MODE -> Icon.ImageVector(Icons.Outlined.NotificationsActive)
            ActionId.CHANGE_RINGER_MODE -> Icon.ImageVector(Icons.Outlined.EditNotifications)
            ActionId.CYCLE_VIBRATE_RING -> Icon.ImageVector(Icons.Outlined.Vibration)
            ActionId.TOGGLE_DND_MODE -> Icon.ImageVector(Icons.Outlined.DoNotDisturb)
            ActionId.ENABLE_DND_MODE -> Icon.ImageVector(Icons.Outlined.DoNotDisturb)
            ActionId.DISABLE_DND_MODE -> Icon.ImageVector(Icons.Outlined.DoNotDisturbOff)
            ActionId.VOLUME_UNMUTE -> Icon.ImageVector(Icons.Outlined.VolumeUp)
            ActionId.VOLUME_MUTE -> Icon.ImageVector(Icons.Outlined.VolumeMute)
            ActionId.VOLUME_TOGGLE_MUTE -> Icon.ImageVector(Icons.Outlined.VolumeMute)
            ActionId.EXPAND_NOTIFICATION_DRAWER -> Icon.ImageVector(Icons.Outlined.Notifications)
            ActionId.TOGGLE_NOTIFICATION_DRAWER -> Icon.ImageVector(Icons.Outlined.Notifications)
            ActionId.EXPAND_QUICK_SETTINGS -> Icon.ImageVector(Icons.Outlined.Tune)
            ActionId.TOGGLE_QUICK_SETTINGS -> Icon.ImageVector(Icons.Outlined.Tune)
            ActionId.COLLAPSE_STATUS_BAR -> Icon.ImageVector(Icons.Outlined.ExpandLess)
            ActionId.PAUSE_MEDIA -> Icon.ImageVector(Icons.Outlined.Pause)
            ActionId.PAUSE_MEDIA_PACKAGE -> Icon.ImageVector(Icons.Outlined.Pause)
            ActionId.PLAY_MEDIA -> Icon.ImageVector(Icons.Outlined.PlayArrow)
            ActionId.PLAY_MEDIA_PACKAGE -> Icon.ImageVector(Icons.Outlined.PlayArrow)
            ActionId.PLAY_PAUSE_MEDIA -> Icon.ImageVector(Icons.Outlined.NotStarted)
            ActionId.PLAY_PAUSE_MEDIA_PACKAGE -> Icon.ImageVector(Icons.Outlined.NotStarted)
            ActionId.NEXT_TRACK -> Icon.ImageVector(Icons.Outlined.SkipNext)
            ActionId.NEXT_TRACK_PACKAGE -> Icon.ImageVector(Icons.Outlined.SkipNext)
            ActionId.PREVIOUS_TRACK -> Icon.ImageVector(Icons.Outlined.SkipPrevious)
            ActionId.PREVIOUS_TRACK_PACKAGE -> Icon.ImageVector(Icons.Outlined.SkipPrevious)
            ActionId.FAST_FORWARD -> Icon.ImageVector(Icons.Outlined.FastForward)
            ActionId.FAST_FORWARD_PACKAGE -> Icon.ImageVector(Icons.Outlined.FastForward)
            ActionId.REWIND -> Icon.ImageVector(Icons.Outlined.FastRewind)
            ActionId.REWIND_PACKAGE -> Icon.ImageVector(Icons.Outlined.FastRewind)
            ActionId.GO_BACK -> Icon.ImageVector(Icons.Outlined.ArrowBack)
            ActionId.GO_HOME -> Icon.ImageVector(Icons.Outlined.Home)
            ActionId.OPEN_RECENTS -> Icon.ImageVector(Icons.Outlined.GridView)
            ActionId.TOGGLE_SPLIT_SCREEN -> Icon.ImageVector(Icons.Outlined.Splitscreen)
            ActionId.GO_LAST_APP -> Icon.ImageVector(Icons.Outlined.Undo)
            ActionId.OPEN_MENU -> Icon.ImageVector(Icons.Outlined.MoreVert)
            ActionId.TOGGLE_FLASHLIGHT -> Icon.ImageVector(Icons.Outlined.FlashlightOn)
            ActionId.ENABLE_FLASHLIGHT -> Icon.ImageVector(Icons.Outlined.FlashlightOn)
            ActionId.DISABLE_FLASHLIGHT -> Icon.ImageVector(Icons.Outlined.FlashlightOff)
            ActionId.ENABLE_NFC -> Icon.ImageVector(Icons.Outlined.Nfc)
            ActionId.DISABLE_NFC -> Icon.DrawableResource(R.drawable.ic_nfc_off)
            ActionId.TOGGLE_NFC -> Icon.ImageVector(Icons.Outlined.Nfc)
            ActionId.MOVE_CURSOR_TO_END -> Icon.DrawableResource(R.drawable.ic_cursor)
            ActionId.TOGGLE_KEYBOARD -> Icon.ImageVector(Icons.Outlined.Keyboard)
            ActionId.SHOW_KEYBOARD -> Icon.ImageVector(Icons.Outlined.Keyboard)
            ActionId.HIDE_KEYBOARD -> Icon.ImageVector(Icons.Outlined.KeyboardHide)
            ActionId.SHOW_KEYBOARD_PICKER -> Icon.ImageVector(Icons.Outlined.List)
            ActionId.TEXT_CUT -> Icon.ImageVector(Icons.Outlined.ContentCut)
            ActionId.TEXT_COPY -> Icon.ImageVector(Icons.Outlined.ContentCopy)
            ActionId.TEXT_PASTE -> Icon.ImageVector(Icons.Outlined.ContentPaste)
            ActionId.SELECT_WORD_AT_CURSOR -> Icon.DrawableResource(R.drawable.outline_abc_24)
            ActionId.SWITCH_KEYBOARD -> Icon.ImageVector(Icons.Outlined.Keyboard)
            ...
            ActionId.SCREENSHOT -> Icon.ImageVector(Icons.Outlined.Screenshot)
            ActionId.OPEN_VOICE_ASSISTANT -> Icon.ImageVector(Icons.Outlined.Mic)
            ActionId.OPEN_DEVICE_ASSISTANT -> Icon.ImageVector(Icons.Outlined.Assistant)
            ActionId.OPEN_CAMERA -> Icon.ImageVector(Icons.Outlined.Camera)
            ActionId.LOCK_DEVICE -> Icon.ImageVector(Icons.Outlined.Lock)
            ActionId.POWER_ON_OFF_DEVICE -> Icon.ImageVector(Icons.Outlined.PowerSettingsNew)
            ActionId.SECURE_LOCK_DEVICE -> Icon.ImageVector(Icons.Outlined.Lock)
            ActionId.CONSUME_KEY_EVENT -> Icon.ImageVector(Icons.Outlined.KeyboardAlt)
            ActionId.OPEN_SETTINGS -> Icon.ImageVector(Icons.Outlined.SettingsApplications)
            ActionId.SHOW_POWER_MENU -> Icon.ImageVector(Icons.Outlined.PowerSettingsNew)

            ActionId.APP -> Icon.ImageVector(Icons.Outlined.Android)
            ActionId.APP_SHORTCUT -> Icon.ImageVector(Icons.Outlined.OpenInNew)
            ActionId.KEY_CODE -> Icon.DrawableResource(R.drawable.ic_q_24)
            ActionId.KEY_EVENT -> Icon.DrawableResource(R.drawable.ic_q_24)
            ActionId.TAP_SCREEN -> Icon.ImageVector(Icons.Outlined.TouchApp)
            ActionId.TEXT -> Icon.ImageVector(Icons.Outlined.ShortText)
            ActionId.URL -> Icon.ImageVector(Icons.Outlined.Link)
            ActionId.INTENT -> Icon.ImageVector(Icons.Outlined.OpenInNew)
            ActionId.PHONE_CALL -> Icon.ImageVector(Icons.Outlined.PhoneInTalk)
            ActionId.SOUND -> Icon.ImageVector(Icons.Outlined.NotificationsActive)
            ActionId.DISMISS_MOST_RECENT_NOTIFICATION -> Icon.ImageVector(Icons.Outlined.ClearAll)
            ActionId.DISMISS_ALL_NOTIFICATIONS -> Icon.ImageVector(Icons.Outlined.ClearAll)
            ActionId.ANSWER_PHONE_CALL -> Icon.ImageVector(Icons.Outlined.Call)
            ActionId.END_PHONE_CALL -> Icon.ImageVector(Icons.Outlined.CallEnd)
        }
    }
