...
object ActionUtils {
    ...
    fun getNewIcon(id: ActionId): KMIcon {
        return when (id) {
            ActionId.TOGGLE_WIFI -> KMIcon.ImageVector(Icons.Outlined.Wifi)
            ActionId.ENABLE_WIFI -> KMIcon.ImageVector(Icons.Outlined.Wifi)
            ActionId.DISABLE_WIFI -> KMIcon.ImageVector(Icons.Outlined.WifiOff)
            ActionId.TOGGLE_BLUETOOTH -> KMIcon.ImageVector(Icons.Outlined.Bluetooth)
            ActionId.ENABLE_BLUETOOTH -> KMIcon.ImageVector(Icons.Outlined.Bluetooth)
            ActionId.DISABLE_BLUETOOTH -> KMIcon.ImageVector(Icons.Outlined.BluetoothDisabled)
            ActionId.TOGGLE_MOBILE_DATA -> KMIcon.ImageVector(Icons.Outlined.SignalCellular4Bar)
            ActionId.ENABLE_MOBILE_DATA -> KMIcon.ImageVector(Icons.Outlined.SignalCellular4Bar)
            ActionId.DISABLE_MOBILE_DATA -> KMIcon.ImageVector(Icons.Outlined.MobiledataOff)
            ActionId.TOGGLE_AUTO_BRIGHTNESS -> KMIcon.ImageVector(Icons.Outlined.BrightnessAuto)
            ActionId.ENABLE_AUTO_BRIGHTNESS -> KMIcon.ImageVector(Icons.Outlined.BrightnessAuto)
            ActionId.DISABLE_AUTO_BRIGHTNESS -> KMIcon.ImageVector(Icons.Outlined.BrightnessLow)
            ActionId.INCREASE_BRIGHTNESS -> KMIcon.ImageVector(Icons.Outlined.BrightnessHigh)
            ActionId.DECREASE_BRIGHTNESS -> KMIcon.ImageVector(Icons.Outlined.BrightnessLow)
            ActionId.TOGGLE_AUTO_ROTATE -> KMIcon.ImageVector(Icons.Outlined.ScreenRotation)
            ActionId.ENABLE_AUTO_ROTATE -> KMIcon.ImageVector(Icons.Outlined.ScreenRotation)
            ActionId.DISABLE_AUTO_ROTATE -> KMIcon.ImageVector(Icons.Outlined.ScreenLockRotation)
            ActionId.PORTRAIT_MODE -> KMIcon.ImageVector(Icons.Outlined.StayCurrentPortrait)
            ActionId.LANDSCAPE_MODE -> KMIcon.ImageVector(Icons.Outlined.StayCurrentLandscape)
            ActionId.SWITCH_ORIENTATION -> KMIcon.ImageVector(Icons.Outlined.RotateLeft)
            ActionId.CYCLE_ROTATIONS -> KMIcon.ImageVector(Icons.Outlined.ScreenRotation)
            ActionId.VOLUME_UP -> KMIcon.ImageVector(Icons.Outlined.VolumeUp)
            ActionId.VOLUME_DOWN -> KMIcon.ImageVector(Icons.Outlined.VolumeDown)
            ActionId.VOLUME_SHOW_DIALOG -> KMIcon.ImageVector(Icons.Outlined.Equalizer)
            ActionId.CYCLE_RINGER_MODE -> KMIcon.ImageVector(Icons.Outlined.NotificationsActive)
            ActionId.CHANGE_RINGER_MODE -> KMIcon.ImageVector(Icons.Outlined.EditNotifications)
            ActionId.CYCLE_VIBRATE_RING -> KMIcon.ImageVector(Icons.Outlined.Vibration)
            ActionId.TOGGLE_DND_MODE -> KMIcon.ImageVector(Icons.Outlined.DoNotDisturb)
            ActionId.ENABLE_DND_MODE -> KMIcon.ImageVector(Icons.Outlined.DoNotDisturb)
            ActionId.DISABLE_DND_MODE -> KMIcon.ImageVector(Icons.Outlined.DoNotDisturbOff)
            ActionId.VOLUME_UNMUTE -> KMIcon.ImageVector(Icons.Outlined.VolumeUp)
            ActionId.VOLUME_MUTE -> KMIcon.ImageVector(Icons.Outlined.VolumeMute)
            ActionId.VOLUME_TOGGLE_MUTE -> KMIcon.ImageVector(Icons.Outlined.VolumeMute)
            ActionId.EXPAND_NOTIFICATION_DRAWER -> KMIcon.ImageVector(Icons.Outlined.Notifications)
            ActionId.TOGGLE_NOTIFICATION_DRAWER -> KMIcon.ImageVector(Icons.Outlined.Notifications)
            ActionId.EXPAND_QUICK_SETTINGS -> KMIcon.ImageVector(Icons.Outlined.Tune)
            ActionId.TOGGLE_QUICK_SETTINGS -> KMIcon.ImageVector(Icons.Outlined.Tune)
            ActionId.COLLAPSE_STATUS_BAR -> KMIcon.ImageVector(Icons.Outlined.ExpandLess)
            ActionId.PAUSE_MEDIA -> KMIcon.ImageVector(Icons.Outlined.Pause)
            ActionId.PAUSE_MEDIA_PACKAGE -> KMIcon.ImageVector(Icons.Outlined.Pause)
            ActionId.PLAY_MEDIA -> KMIcon.ImageVector(Icons.Outlined.PlayArrow)
            ActionId.PLAY_MEDIA_PACKAGE -> KMIcon.ImageVector(Icons.Outlined.PlayArrow)
            ActionId.PLAY_PAUSE_MEDIA -> KMIcon.ImageVector(Icons.Outlined.NotStarted)
            ActionId.PLAY_PAUSE_MEDIA_PACKAGE -> KMIcon.ImageVector(Icons.Outlined.NotStarted)
            ActionId.NEXT_TRACK -> KMIcon.ImageVector(Icons.Outlined.SkipNext)
            ActionId.NEXT_TRACK_PACKAGE -> KMIcon.ImageVector(Icons.Outlined.SkipNext)
            ActionId.PREVIOUS_TRACK -> KMIcon.ImageVector(Icons.Outlined.SkipPrevious)
            ActionId.PREVIOUS_TRACK_PACKAGE -> KMIcon.ImageVector(Icons.Outlined.SkipPrevious)
            ActionId.FAST_FORWARD -> KMIcon.ImageVector(Icons.Outlined.FastForward)
            ActionId.FAST_FORWARD_PACKAGE -> KMIcon.ImageVector(Icons.Outlined.FastForward)
            ActionId.REWIND -> KMIcon.ImageVector(Icons.Outlined.FastRewind)
            ActionId.REWIND_PACKAGE -> KMIcon.ImageVector(Icons.Outlined.FastRewind)
            ActionId.GO_BACK -> KMIcon.ImageVector(Icons.Outlined.ArrowBack)
            ActionId.GO_HOME -> KMIcon.ImageVector(Icons.Outlined.Home)
            ActionId.OPEN_RECENTS -> KMIcon.ImageVector(Icons.Outlined.GridView)
            ActionId.TOGGLE_SPLIT_SCREEN -> KMIcon.ImageVector(Icons.Outlined.Splitscreen)
            ActionId.GO_LAST_APP -> KMIcon.ImageVector(Icons.Outlined.Undo)
            ActionId.OPEN_MENU -> KMIcon.ImageVector(Icons.Outlined.MoreVert)
            ActionId.TOGGLE_FLASHLIGHT -> KMIcon.ImageVector(Icons.Outlined.FlashlightOn)
            ActionId.ENABLE_FLASHLIGHT -> KMIcon.ImageVector(Icons.Outlined.FlashlightOn)
            ActionId.DISABLE_FLASHLIGHT -> KMIcon.ImageVector(Icons.Outlined.FlashlightOff)
            ActionId.ENABLE_NFC -> KMIcon.ImageVector(Icons.Outlined.Nfc)
            ActionId.DISABLE_NFC -> KMIcon.DrawableResource(R.drawable.ic_nfc_off)
            ActionId.TOGGLE_NFC -> KMIcon.ImageVector(Icons.Outlined.Nfc)
            ActionId.MOVE_CURSOR_TO_END -> KMIcon.DrawableResource(R.drawable.ic_cursor)
            ActionId.TOGGLE_KEYBOARD -> KMIcon.ImageVector(Icons.Outlined.Keyboard)
            ActionId.SHOW_KEYBOARD -> KMIcon.ImageVector(Icons.Outlined.Keyboard)
            ActionId.HIDE_KEYBOARD -> KMIcon.ImageVector(Icons.Outlined.KeyboardHide)
            ActionId.SHOW_KEYBOARD_PICKER -> KMIcon.ImageVector(Icons.Outlined.List)
            ActionId.TEXT_CUT -> KMIcon.ImageVector(Icons.Outlined.ContentCut)
            ActionId.TEXT_COPY -> KMIcon.ImageVector(Icons.Outlined.ContentCopy)
            ActionId.TEXT_PASTE -> KMIcon.ImageVector(Icons.Outlined.ContentPaste)
            ActionId.SELECT_WORD_AT_CURSOR -> KMIcon.DrawableResource(R.drawable.outline_abc_24)
            ActionId.SWITCH_KEYBOARD -> KMIcon.ImageVector(Icons.Outlined.Keyboard)
            ActionId.TOGGLE_AIRPLANE_MODE -> KMIcon.ImageVector(Icons.Outlined.AirplanemodeActive)
            ActionId.ENABLE_AIRPLANE_MODE -> KMIcon.ImageVector(Icons.Outlined.AirplanemodeActive)
            ActionId.DISABLE_AIRPLANE_MODE -> KMIcon.ImageVector(Icons.Outlined.AirplanemodeInactive)
            ActionId.SCREENSHOT -> KMIcon.ImageVector(Icons.Outlined.Screenshot)
            ActionId.OPEN_VOICE_ASSISTANT -> KMIcon.ImageVector(Icons.Outlined.Mic)
            ActionId.OPEN_DEVICE_ASSISTANT -> KMIcon.ImageVector(Icons.Outlined.Assistant)
            ActionId.OPEN_CAMERA -> KMIcon.ImageVector(Icons.Outlined.Camera)
            ActionId.LOCK_DEVICE -> KMIcon.ImageVector(Icons.Outlined.Lock)
            ActionId.POWER_ON_OFF_DEVICE -> KMIcon.ImageVector(Icons.Outlined.PowerSettingsNew)
            ActionId.SECURE_LOCK_DEVICE -> KMIcon.ImageVector(Icons.Outlined.Lock)
            ActionId.CONSUME_KEY_EVENT -> KMIcon.ImageVector(Icons.Outlined.KeyboardAlt)
            ActionId.OPEN_SETTINGS -> KMIcon.ImageVector(Icons.Outlined.SettingsApplications)
            ActionId.SHOW_POWER_MENU -> KMIcon.ImageVector(Icons.Outlined.PowerSettingsNew)

            ActionId.APP -> KMIcon.ImageVector(Icons.Outlined.Android)
            ActionId.APP_SHORTCUT -> KMIcon.ImageVector(Icons.Outlined.OpenInNew)
            ActionId.KEY_CODE -> KMIcon.DrawableResource(R.drawable.ic_q_24)
            ActionId.KEY_EVENT -> KMIcon.DrawableResource(R.drawable.ic_q_24)
            ActionId.TAP_SCREEN -> KMIcon.ImageVector(Icons.Outlined.TouchApp)
            ActionId.TEXT -> KMIcon.ImageVector(Icons.Outlined.ShortText)
            ActionId.URL -> KMIcon.ImageVector(Icons.Outlined.Link)
            ActionId.INTENT -> KMIcon.ImageVector(Icons.Outlined.OpenInNew)
            ActionId.PHONE_CALL -> KMIcon.ImageVector(Icons.Outlined.PhoneInTalk)
            ActionId.SOUND -> KMIcon.ImageVector(Icons.Outlined.NotificationsActive)
            ActionId.DISMISS_MOST_RECENT_NOTIFICATION -> KMIcon.ImageVector(Icons.Outlined.ClearAll)
            ActionId.DISMISS_ALL_NOTIFICATIONS -> KMIcon.ImageVector(Icons.Outlined.ClearAll)
            ActionId.ANSWER_PHONE_CALL -> KMIcon.ImageVector(Icons.Outlined.Call)
            ActionId.END_PHONE_CALL -> KMIcon.ImageVector(Icons.Outlined.CallEnd)
        }
    }
