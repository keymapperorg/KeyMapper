...
class LegacyFingerprintMapMigrationTest {
    companion object {
        private val MIGRATION_0_1_TEST_DATA =
            arrayOf(
        ...
        private val MIGRATION_0_1_EXPECTED_DATA =
            arrayOf(
    ...
    fun `migrate 0 to 1`() {
        val testData =
            MIGRATION_0_1_TEST_DATA
                .map {
                    parser.parse(it)
                }.toJsonArray()

        val expectedData =
            MIGRATION_0_1_EXPECTED_DATA
                .map {
                    parser.parse(it)
                }.toJsonArray()
