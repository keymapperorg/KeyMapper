...
class ConfigSettingsUseCaseImpl
    ...
    constructor(
        ...
        override val isWriteSecureSettingsGranted: Flow<Boolean> =
            channelFlow {
        ...
        override val isCompatibleImeChosen: Flow<Boolean> =
            inputMethodAdapter.chosenIme.map {
                imeHelper.isCompatibleImeChosen()
            }

        override val isCompatibleImeEnabled: Flow<Boolean> =
            inputMethodAdapter.inputMethods.map {
