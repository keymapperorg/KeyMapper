...
class ChooseAppViewModel
    ...
    constructor(
        ...
        private val launchableAppListItems =
            useCase.installedPackages
                .map { state ->
                    state.mapData { packages ->
                        packages
        ...
        init {
            combine(
                ...
                val packagesToFilter =
                    if (allowHiddenApps && showHiddenApps) {
                        allAppListItems
                    } else {
                        launchableAppListItems
                    }
        ...
        private suspend fun List<PackageInfo>.buildListItems(): List<SimpleListItemOld> =
            flow {
                forEach { packageInfo ->
                    val name =
                        useCase
                    ...
                    val icon =
                        useCase
                            .getAppIcon(packageInfo.packageName)
                            .valueOrNull() ?: return@forEach
