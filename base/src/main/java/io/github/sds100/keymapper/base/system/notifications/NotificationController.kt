...
class NotificationController
    ...
    constructor(
        ...
        fun init() {
            ...
            toggleCompatibleIme.sufficientPermissions
                .onEach { canToggleIme ->
                    if (canToggleIme) {
                        manageNotifications.createChannel(
                            NotificationChannelModel(
            ...
            hideInputMethod.onHiddenChange
                .onEach { isHidden ->
                    manageNotifications.createChannel(
                        NotificationChannelModel(
            ...
            manageNotifications.onActionClick
                .onEach { actionId ->
                    when (actionId) {
        ...
        private fun mappingsPausedNotification(): NotificationModel {
            ...
            val stopServiceAction =
                if (controlAccessibilityService.isUserInteractionRequired()) {
        ...
        private fun floatingButtonFeatureNotification(): NotificationModel =
            NotificationModel(
