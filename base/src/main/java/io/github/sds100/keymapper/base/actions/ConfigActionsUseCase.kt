...
@ViewModelScoped
class ConfigActionsUseCaseImpl
    @Inject
    constructor(
        ...
        override fun addAction(data: ActionData) {
            state.update { keyMap ->
                val newActionList =
                    keyMap.actionList.toMutableList().apply {
        ...
        override fun setActionRepeatEnabled(
            uid: String,
            repeat: Boolean,
        ) {
        ...
        override fun setActionRepeatRate(
            uid: String,
            repeatRate: Int,
        ) {
        ...
        override fun setActionRepeatDelay(
            uid: String,
            repeatDelay: Int,
        ) {
            setActionOption(uid) { action ->
        ...
        override fun setActionRepeatLimit(
            uid: String,
            repeatLimit: Int,
        ) {
            setActionOption(uid) { action ->
        ...
        override fun setActionHoldDownEnabled(
            uid: String,
            holdDown: Boolean,
        ) = setActionOption(uid) { it.copy(holdDown = holdDown) }

        override fun setActionHoldDownDuration(
            uid: String,
            holdDownDuration: Int,
        ) {
            setActionOption(uid) { action ->
        ...
        override fun setActionStopHoldingDownWhenTriggerPressedAgain(
            uid: String,
            enabled: Boolean,
        ) = setActionOption(uid) { it.copy(stopHoldDownWhenTriggerPressedAgain = enabled) }

        override fun setActionMultiplier(
            uid: String,
            multiplier: Int,
        ) {
            setActionOption(uid) { action ->
        ...
        override fun setDelayBeforeNextAction(
            uid: String,
            delay: Int,
        ) {
            setActionOption(uid) { action ->
...
interface ConfigActionsUseCase : GetDefaultKeyMapOptionsUseCase {
    ...
    fun setActionMultiplier(
        uid: String,
        multiplier: Int,
    )

    fun setDelayBeforeNextAction(
        uid: String,
        delay: Int,
    )

    fun setActionRepeatRate(
        uid: String,
        repeatRate: Int,
    )

    fun setActionRepeatLimit(
        uid: String,
        repeatLimit: Int,
    )
    ...
    fun setActionRepeatEnabled(
        uid: String,
        repeat: Boolean,
    )

    fun setActionRepeatDelay(
        uid: String,
        repeatDelay: Int,
    )

    fun setActionHoldDownEnabled(
        uid: String,
        holdDown: Boolean,
    )

    fun setActionHoldDownDuration(
        uid: String,
        holdDownDuration: Int,
    )
    ...
    fun setActionStopHoldingDownWhenTriggerPressedAgain(
        uid: String,
        enabled: Boolean,
    )
}
