...
fun KMError.getFullMessage(ctx: Context): String = getFullMessage(ResourceProviderImpl(ctx))
    ...
    when (this) {
        ...
        is KMError.SystemFeatureNotSupported ->
            when (this.feature) {
                ...
                PackageManager.FEATURE_TELEPHONY, PackageManager.FEATURE_TELEPHONY_DATA, PackageManager.FEATURE_TELEPHONY_MESSAGING ->
                    resourceProvider.getString(
