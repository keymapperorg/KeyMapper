...
val KeyMapperIcons.ProModeIconDisabled: ImageVector
    get() {
        if (_ProModeDisabled != null) {
            return _ProModeDisabled!!
        }
        _ProModeDisabled = ImageVector.Builder(
            name = "ProModeDisabled",
            defaultWidth = 32.dp,
            defaultHeight = 32.dp,
            viewportWidth = 32f,
            viewportHeight = 32f
...
private var _ProModeDisabled: ImageVector? = null
