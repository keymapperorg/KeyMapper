...
class OnboardingUseCaseImpl
    ...
    constructor(
        ...
        override val showWhatsNew =
            get(Keys.lastInstalledVersionCodeHomeScreen)
         ...
         */
        override val showFloatingButtonFeatureNotification: Flow<Boolean> =
            combine(
        ...
        override val promptForShizukuPermission: Flow<Boolean> =
            combine(
