...
class DetectKeyMapsUseCaseImpl
    ...
    constructor(
        ...
        override val allKeyMapList: Flow<List<DetectKeyMapModel>> =
            combine(
            ...
            allKeyMapList.map { models ->
                models.any { model ->
                    model.keyMap.isEnabled &&
                        model.keyMap.trigger.keys
                            .any { it is FingerprintTriggerKey }
                }
            }
            ...
            if (inputEventHub.isSystemBridgeConnected()) {
                ...
                when (keyCode) {
                    ...
                    KeyEvent.KEYCODE_APP_SWITCH ->
                        accessibilityService.doGlobalAction(
        ...
        override fun imitateEvdevEvent(
            devicePath: String,
            type: Int,
            code: Int,
            value: Int,
