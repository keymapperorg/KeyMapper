...
@ViewModelScoped
class ConfigConstraintsUseCaseImpl
    @Inject
    constructor(
            ...
            combine(
                ...
                shortcutData
                    .filter { constraintData ->
                        !keyMap.data.constraintState.constraints
                            .any { it.data == constraintData }
                    }.take(5)
            }
        ...
        override fun removeConstraint(id: String) {
            updateConstraintState { oldState ->
                val newList =
                    oldState.constraints.toMutableSet().apply {
                        removeAll { it.uid == id }
                    }
