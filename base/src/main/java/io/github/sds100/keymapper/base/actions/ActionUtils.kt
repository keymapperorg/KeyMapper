...
object ActionUtils {
    ...
    @DrawableRes
    fun getDrawableIcon(id: ActionId): Int? =
        when (id) {
    ...
    fun getComposeIcon(id: ActionId): ImageVector =
        when (id) {
...
fun ActionData.canBeHeldDown(): Boolean =
    when (this) {
        is ActionData.InputKeyEvent -> true
        else -> false
    }

fun ActionData.canUseImeToPerform(): Boolean =
    when (this) {
        is ActionData.InputKeyEvent -> true
...
fun ActionData.isEditable(): Boolean =
    when (this) {
        is ActionData.App,
