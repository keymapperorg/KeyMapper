...
private fun TriggerScreenVertical(
    ...
    configState: _root_ide_package_.io.github.sds100.keymapper.mapping.trigger.ConfigTriggerState,
    recordTriggerState: RecordTriggerState,
    ...
    Surface(modifier = modifier) {
        Column {
            when (configState) {
                is _root_ide_package_.io.github.sds100.keymapper.mapping.trigger.ConfigTriggerState.Empty -> {
                    Column(
                        modifier = Modifier
                            .weight(1f)
                ...
                is _root_ide_package_.io.github.sds100.keymapper.mapping.trigger.ConfigTriggerState.Loaded -> {
            ...
            RecordTriggerButtonRow(
                ...
                showRecordTriggerTapTarget = (configState as? _root_ide_package_.io.github.sds100.keymapper.mapping.trigger.ConfigTriggerState.Empty)?.showRecordTriggerTapTarget
                    ?: false,
...
private fun TriggerScreenHorizontal(
    ...
    Surface(modifier = modifier) {
        when (configState) {
            is _root_ide_package_.io.github.sds100.keymapper.mapping.trigger.ConfigTriggerState.Empty -> Row {
                Text(
                    modifier = Modifier
                        .widthIn(max = 400.dp)
                        .padding(32.dp)
            ...
            is _root_ide_package_.io.github.sds100.keymapper.mapping.trigger.ConfigTriggerState.Loaded -> Row {
                TriggerList(
                    modifier = Modifier
                        .fillMaxHeight()
                        .widthIn(max = 400.dp),
...
private fun TriggerList(
    modifier: Modifier = Modifier,
    triggerList: List<_root_ide_package_.io.github.sds100.keymapper.mapping.trigger.TriggerKeyListItemModel>,
...
private val sampleList = listOf(
    _root_ide_package_.io.github.sds100.keymapper.mapping.trigger.TriggerKeyListItemModel.KeyCode(
        id = "id1",
        keyName = "Volume Up",
    ...
    _root_ide_package_.io.github.sds100.keymapper.mapping.trigger.TriggerKeyListItemModel.Assistant(
        id = "id3",
...
private val previewState = _root_ide_package_.io.github.sds100.keymapper.mapping.trigger.ConfigTriggerState.Loaded(
...
private fun VerticalEmptyPreview() {
    KeyMapperTheme {
        TriggerScreenVertical(
            configState = _root_ide_package_.io.github.sds100.keymapper.mapping.trigger.ConfigTriggerState.Empty(
                shortcuts = setOf(
                    ShortcutModel(
                        icon = ComposeIconInfo.Vector(Icons.Rounded.Fingerprint),
                        text = "Fingerprint gesture",
