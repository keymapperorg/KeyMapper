...
fun TriggerKeyListItem(
    ...
    model: _root_ide_package_.io.github.sds100.keymapper.mapping.trigger.TriggerKeyListItemModel,
    index: Int,
    ...
    Column(modifier = modifier.fillMaxWidth()) {
        ElevatedCard(
            ...
            Row(
                ...
                if (model.error == null) {
                    val icon = when (model) {
                        is _root_ide_package_.io.github.sds100.keymapper.mapping.trigger.TriggerKeyListItemModel.Assistant -> Icons.Outlined.Assistant
                        is _root_ide_package_.io.github.sds100.keymapper.mapping.trigger.TriggerKeyListItemModel.FloatingButton -> Icons.Outlined.BubbleChart
                        is _root_ide_package_.io.github.sds100.keymapper.mapping.trigger.TriggerKeyListItemModel.FingerprintGesture -> Icons.Outlined.Fingerprint
                        else -> null
                    }
                ...
                val primaryText = when (model) {
                    is _root_ide_package_.io.github.sds100.keymapper.mapping.trigger.TriggerKeyListItemModel.Assistant -> when (model.assistantType) {
                    ...
                    is _root_ide_package_.io.github.sds100.keymapper.mapping.trigger.TriggerKeyListItemModel.FloatingButton -> stringResource(
                        R.string.trigger_key_floating_button_description,
                        model.buttonName,
                    )

                    is _root_ide_package_.io.github.sds100.keymapper.mapping.trigger.TriggerKeyListItemModel.KeyCode -> model.keyName
                    ...
                    is _root_ide_package_.io.github.sds100.keymapper.mapping.trigger.TriggerKeyListItemModel.FingerprintGesture -> when (model.gestureType) {
                ...
                if (model.error == null) {
                    ...
                    val tertiaryText = when (model) {
                        is _root_ide_package_.io.github.sds100.keymapper.mapping.trigger.TriggerKeyListItemModel.KeyCode -> model.extraInfo
                        is _root_ide_package_.io.github.sds100.keymapper.mapping.trigger.TriggerKeyListItemModel.FloatingButton -> model.layoutName
                ...
                CompositionLocalProvider(
                    ...
                    if (model !is _root_ide_package_.io.github.sds100.keymapper.mapping.trigger.TriggerKeyListItemModel.FloatingButtonDeleted) {
...
private fun KeyCodePreview() {
    TriggerKeyListItem(
        model = _root_ide_package_.io.github.sds100.keymapper.mapping.trigger.TriggerKeyListItemModel.KeyCode(
            id = "id",
            keyName = "Volume Up",
...
private fun AssistantPreview() {
    TriggerKeyListItem(
        model = _root_ide_package_.io.github.sds100.keymapper.mapping.trigger.TriggerKeyListItemModel.Assistant(
            id = "id",
...
private fun FloatingButtonPreview() {
    TriggerKeyListItem(
        model = _root_ide_package_.io.github.sds100.keymapper.mapping.trigger.TriggerKeyListItemModel.FloatingButton(
            id = "id",
            buttonName = "😎",
            layoutName = "Gaming",
            clickType = ClickType.DOUBLE_PRESS,
...
private fun FloatingButtonErrorPreview() {
    TriggerKeyListItem(
        model = _root_ide_package_.io.github.sds100.keymapper.mapping.trigger.TriggerKeyListItemModel.FloatingButtonDeleted(
            id = "id",
            clickType = ClickType.DOUBLE_PRESS,
            linkType = LinkType.ARROW,
        ),
