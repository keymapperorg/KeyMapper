...
class OpenMenuHelper(
    ...
    private val accessibilityService: io.github.sds100.keymapper.base.system.accessibility.IAccessibilityService,
        ...
        when {
            ...
            suAdapter.isGranted.firstBlocking() ->
                ...
                accessibilityService.performActionOnNode({ it.contentDescription == OVERFLOW_MENU_CONTENT_DESCRIPTION }) {
                    io.github.sds100.keymapper.base.system.accessibility.AccessibilityNodeAction(
